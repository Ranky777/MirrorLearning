...
public class PongNetworkManager : NetworkManager
{
    ...
    public static new PongNetworkManager singleton => (PongNetworkManager)NetworkManager.singleton;
    ...
    public override void OnServerAddPlayer(NetworkConnectionToClient conn)
    {
        ...
        // 如果有两个玩家了，通知比赛管理器准备开始
        if (numPlayers == 2)
        {
            PongMatchManager.Instance.StartRoundSequence();
        }
    }
    ...
    public override void OnStartServer()
    {
        ...
        // 生成全局唯一的比赛管理器，并赋予网络身份
        GameObject matchManagerInstance = Instantiate(matchManagerPrefab);
        NetworkServer.Spawn(matchManagerInstance);
    }
